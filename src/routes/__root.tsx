...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Learning Intelligence System" },
      { name: "description", content: "A personalized learning platform for students." },
      { property: "og:title", content: "Learning Intelligence System" },
